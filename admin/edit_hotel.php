<?php
    ...
    $sql = "UPDATE `hotel` SET `rname`='$name',`rphoto`='$image',`rprice`='$price',`rloc`='$loc',`rdesc`='$desc' WHERE id='$id'";
    $query_run = mysqli_query($con, $sql);

    if ($query_run){
      echo '<script type="text/javascript">alert("data are edited successfully...")</script>';
      echo "<script>window.location.href='manage_hotel.php'</script>";
      }
    else{
      die("failed to insert ".mysqli_error($con));
      echo "<script>window.location.href='edit_hotel.php'</script>";
      }
    }
?>
            ...
            <div class="placee">
                ...
                <?php
                    ...
                    <div class="pro-image">
                        ...
                        <img src='<?php echo '../images/'.$data['rphoto'];?>' onclick="triggerClick()" id="imagedisplay" style="margin-left:1px;">
                    ...
                    <div class="place-details">
                        ...
                        <div class="input">
                            ...
                            <input type="text" name="rname" id="" required class="form-control" value="<?php echo $data['rname']?>"><br>   
                            <label for="">Hotel Price</label><br>
                            <input type="number" name="rprice" id="" required class="form-control" value="<?php echo $data['rprice']?>"><br>
                            <label for="">Location</label><br>
                            <input type="text" name="rloc" id="" required class="form-control" value="<?php echo $data['rloc']?>"><br>
                            <label for="">Description</label><br>
                            <textarea name="rdesc" id="mytextarea" cols="30" rows="10" ><?php echo $data['rdesc']?></textarea>
