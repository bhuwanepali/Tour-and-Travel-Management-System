            ...
            <div class="admindetails">
                <div class="box">
                    ...
                    <form action="reupload.php" method="post" enctype="multipart/form-data">
                        ...
                        <input type="file" style="margin:5px;" name="my_video" value="<?php echo $data['video'];?>" required>
                        <input type="text" style="margin:5px;" name="vname" placeholder="Enter place name" value="<?php echo $data['vname'];?> " required>
                        <select name="pcode" style="margin:5px;" id="" class="form-control" style='color:#30637c;' required>
                        ...
                        <input type="submit" style="margin-left:5px; text-align:center;" name="submit" value="save upload">                    
                    </form>
                    <?php } }?>
                </div>
            </div>
