        ...
        <div class="admindetails">
            <div class="box">
                ...
                <form name="form" method="post" action="aprofile.php" enctype="multipart/form-data" id="uploadFormm">
                    ...
                    <input type="text" name="name" placeholder="Enter your name" style="margin-bottom:10px;" >
                    <input type="text" name="mail" placeholder="Enter your email" style="margin-bottom:10px;">
                    <input type="text" name="address" placeholder="Enter your address" style="margin-bottom:10px;">
                    <input type="text" name="contact" placeholder="Enter your contact" style="margin-bottom:10px;">
                    <input type="password" name="pass" placeholder="Enter your password" style="margin-bottom:10px;">
