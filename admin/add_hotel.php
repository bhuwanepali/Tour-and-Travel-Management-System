<?php
    ...
    $sql = "INSERT INTO `hotel`(`rname`, `rphoto`,`rdesc`,`rloc`, `rprice`) VALUES ('$name','$image','$desc','$loc','$price')" or die ("query incorrect");
    ...
    if ($query_run){
      ...
      echo "<script>window.location.href='add_hotel.php'</script>";
      }
    }
?>
                ...
                <form name="form" method="post" action="" enctype="multipart/form-data" id="uploadForm">
                    ...
                    <div class="place-details">
                        ...
                        <div class="input">
                            ...
                            <input type="text" name="rname" id="" required class="form-control"><br>   
                            <label for="">Location</label><br>
                            <input type="text" name="rloc" id="" required class="form-control"><br>   
                            <label for="">Price</label><br>
                            <input type="number" name="rprice" id="" required class="form-control"><br>
                            <label for="">Description</label><br>
                            <textarea name="rdesc" id="mytextarea"></textarea>
