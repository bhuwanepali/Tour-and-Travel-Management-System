<?php
    ...
    $name = $_POST['tname'];
  	$price = $_POST['tprice'];
  	$desc = $_POST['tdesc'];
  	$sit = $_POST['no_of_sits'];

    move_uploaded_file($_FILES['Image']['tmp_name'], $target);
    $sql = "UPDATE `transportation` SET `tname`='$name',`tphoto`='$image',`tprice`='$price',`no_of_sits`='$sit',`tdesc`='$desc' WHERE id='$id'";
    ...
    if ($query_run){
      ...
      echo "<script>window.location.href='edit_transportation.php'</script>";
      }
    }
?>
            ...
            <div class="placee">
                ...
                <?php
                    ...
                    <div class="pro-image">
                        ...
                        <img src='<?php echo '../images/'.$data['tphoto'];?>' onclick="triggerClick()" id="imagedisplay" style="margin-left:1px;">
                    ...
                    <div class="place-details">
                        ...
                        <div class="input">
                            ...
                            <input type="text" name="tname" id="" required class="form-control" value="<?php echo $data['tname']?>"><br>   
                            <label for="">Transportation Price</label><br>
                            <input type="text" name="tprice" id="" required class="form-control" value="<?php echo $data['tprice']?>"><br>
                            <label for="">No. of sits</label><br>
                            <input type="text" name="no_of_sits" id="" required class="form-control" value="<?php echo $data['no_of_sits']?>"><br>
                            <label for="" style="padding-left:0px;">Description</label>
                            <textarea name="tdesc" id="mytextarea" cols="30" rows="10"><?php echo $data['tdesc']; ?></textarea><br>
