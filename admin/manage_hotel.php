...
<html lang="en">
    ...
    <body id="body-pd">
        ...
        <div class="list-header">
            <h3>Hotel list<a href="add_hotel.php"><i style="width:30px;text-align" class="fas fa-plus"></i></a></h3>
        </div>
        <table class="plist">
            <thead class="heading">
                <tr>
            ...
            <?php
                ...
                $statement = "hotel ORDER BY id asc"; //you have to pass your query over here
