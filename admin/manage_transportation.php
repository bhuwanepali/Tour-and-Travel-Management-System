<?php
    ...
    if(isset($_GET['del'])){
        $id=$_GET['del'];
        mysqli_query($con,"DELETE FROM transportation WHERE id = '$id'");
    }
?>
...
<html lang="en">
    ...
    <body id="body-pd">
        ...
        <div class="list-header">
            <h3>Transportation list<a href="add_transportation.php"><i style="width:30px;text-align" class="fas fa-plus"></i></a></h3>
        </div>
        <table class="plist">
            <thead class="heading">
                <tr>
            ...
            <?php
                ...
                $statement = "transportation ORDER BY id asc"; //you have to pass your query over here
                ...
                while($data=mysqli_fetch_array($res))
                    ...
                    <tr>
                        ...
                        <td><?php echo "<img src='../images/".$data['tphoto']."'>";?></td>
                        <td>$<?php echo $data["tprice"];?></td>
                        <td><?php echo $data['no_of_sits'];?></td>
                        <td><a href="edit_transportation.php?id=<?php echo $data["id"];?>"><i class="fas fa-edit"></i></a>&nbsp;&nbsp;&nbsp;&nbsp;
                        <a href="manage_transportation.php?del=<?php echo $data["id"];?>" onclick="return confirm('Are you sure?');"><i class="fas fa-times-circle"></i></a></td>
                    </tr>
                <?php } ?>        
            </tbody>
        </table>
