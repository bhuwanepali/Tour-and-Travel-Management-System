                    ...
                    <div class="row justify-content-center">
                        <div class="col-xl-8">
                            <div class="room-details-thumb">
                                <img src="assets/img/room/familyroomcover.jpg" alt="">
                                <ul>
                                    <li class="more"><a href="#">more <i class="flaticon-right"></i></a></li>
                                    <li class="expand"><a href="assets/img/room/familyroomcover.jpg" class="popup-image">Expand <i class="flaticon-full-size"></i></a></li>
                                </ul>
                            </div>
                            <div class="room-details-content">
                                <div class="content-top">
                                    <div class="left-side">
                                        ...
                                        <h2 class="title black-title">Family Room</h2>
                                        <ul>
                                            <li>People <span>4</span></li>
                                            <li>bed(s) <span>2 King</span></li>
                                            <li>sq ft <span>94</span></li>
