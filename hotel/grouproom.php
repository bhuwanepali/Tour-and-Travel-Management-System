                    ...
                    <div class="row justify-content-center">
                        <div class="col-xl-8">
                            <div class="room-details-thumb">
                                <img src="assets/img/room/grouproomcover.jpg" alt="">
                                <ul>
                                    <li class="more"><a href="#">more <i class="flaticon-right"></i></a></li>
                                    <li class="expand"><a href="assets/img/room/grouproomcover.jpg" class="popup-image">Expand <i class="flaticon-full-size"></i></a></li>
                                </ul>
                            </div>
                            <div class="room-details-content">
                                <div class="content-top">
                                    <div class="left-side">
                                        ...
                                        <h2 class="title black-title">Group Room</h2>
                                        <ul>
                                            <li>People <span>6</span></li>
                                            <li>bed(s) <span>4 King</span></li>
                                            <li>sq ft <span>120</span></li>
                            ...
                            <div class="ideal-room">
                                ...
                                <ul>
                                    <li><a href="#">Tour</a></li>
                                    <li><a href="#">Large Group People</a></li>
                                </ul>
                            </div>
